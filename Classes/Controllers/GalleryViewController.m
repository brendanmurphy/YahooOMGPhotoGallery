...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    NSInteger itemsInTable = [self.model.galleryQueryArray count];
    NSLog(@"itemsInTable: %d", itemsInTable);
    NSLog(@"self.model.total: %d", self.model.total);
    
    if(self.model.galleriesIdArray || itemsInTable < self.model.total) {
